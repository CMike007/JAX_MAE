    ...
    def __init__(self,alphatradePath):
        ...
        def load_LOBSTER(sliceTimeWindow, stepLines, messagePath, orderbookPath, start_time, end_time):
            ...
            def preProcessingMassegeOB(message, orderbook):
                ...
                '''
                original, changed by Mike 10.06)
        ...
        self.TRACK = Cubes_withOB

        '''
        print('length Cubes with OB')
        print(len(Cubes_withOB))
        print(' ')
        print('Cubes with OB - 0 - 0')
        print(Cubes_withOB[0][0])
        print(Cubes_withOB[0][0].shape)
        print(' ')
        print('Cubes with OB - 0 - 0 - 0')
        print(Cubes_withOB[0][0][0])
        print(Cubes_withOB[0][0][0].shape)
        print(' ')
        print('Cubes with OB 1')
        print(Cubes_withOB[0][1])
        print(Cubes_withOB[0][1].shape)
        print(' ')
        print('length Max Steps')
        print(len(max_steps_in_episode_arr))
        '''
