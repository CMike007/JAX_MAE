...
class ExecutionEnv(BaseLOBEnv):
    ...
    def step_env(
        ...
        #jax.debug.print("Quantity Bought: {}", state.quant_BUY_TA)
        ...
        #jax.debug.print("TAction scaled and selected: {}", action_TAgent)
        ...
        # TAgent
        #mask_TAgent = (00000000 == executed[:, 2])  # CHANGE_BACK_HERE_0730
        ...
        Flow_TA = (buy_obj + sell_obj) * mid_price * 0.0005

        #Just for tracking purposes:
        PnL = PnL_TA(self.gamma_TA)

        #jax.debug.print('Inventory: {}', state.inventory_TA)
        #jax.debug.print('Change of mid: {}', mid_price - state.last_mid)
        #jax.debug.print('PnL: {}', PnL)
        #jax.debug.print('Flow: {}', Flow_TA)
