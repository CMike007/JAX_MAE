...
if __name__ == "__main__":
    ...
    ppo_config = {
        ...
        "TOTAL_TIMESTEPS": 5e6,     # reduced from 1e8 (last run #dandy-leaf-28 was done with 1e6 --> 2h runtime)
        ...
        "NUM_STEPS": 455,           # brought down from 455
        ...
        "OOE": {
            ...
            "MAX_GRAD_NORM": 2.0,
            "ANNEAL_LR": True,
            "Episode_Time": 60*20, #60seconds times 20 minutes = 1200seconds
        },
        "TAgent": {
            "TASK_SIZE":200,
            "LR": 2.5e-5,
